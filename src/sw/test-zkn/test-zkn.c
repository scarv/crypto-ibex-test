...
extern uint32_t test_rdseed();
extern uint32_t test_rdmseccfg();
...
int main() {
    ...
    //rdseed
    //result = test_rdseed();
    //puts("Read random seedcsr at 0x015 got: "); puthex(result); putchar('\n');
    //rdmseccfg
    //result = test_rdmseccfg();
    //puts("Read mseccfg at 0x747 got: "); puthex(result); putchar('\n');
